...
public class stockAdapter extends RecyclerView.Adapter<stockAdapter.ViewHolder>{
    ...
    public stockAdapter(ArrayList<Item> productDomains, Context context, ChangeNumberItemsListener changeNumberItemsListener) {
    ...
    public stockAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new stockAdapter.ViewHolder(inflate);
    }
    ...
    public void onBindViewHolder(@NonNull stockAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.plusItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                managementCart.plusNumberStock(productDomains, position, new ChangeNumberItemsListener() {
                    @Override
                    public void changed()  {
        ...
        holder.minusItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                managementCart.minusNumberStock(productDomains, position, new ChangeNumberItemsListener() {
                    @Override
                    public void changed() {
                        notifyDataSetChanged();
                        changeNumberItemsListener.changed();
